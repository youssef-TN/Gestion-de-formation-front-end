...
const Dashboard = ({currentUser}) => {
  ...
  // État et données pour les notifications
  const [notifications, setNotifications] = React.useState([
    { id: 1, name: 'John Doe', message: 'commented on your post', unread: true },
    { id: 2, name: 'Mary Smith', message: 'sent you a friend request', unread: true },
    { id: 3, name: 'Alex Wilson', message: 'shared a document with you', unread: false }
  ]);
    ...
    <div className="p-6">
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Composant de notification original pour les notifications */}
          <div className="space-y-6">
            <div className="flex justify-between items-center">
